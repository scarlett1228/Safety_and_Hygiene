...
public class RoadStatisticActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_road_statistic);

        //toolbar
        toolbar=findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        chart = findViewById(R.id.fragment_roadbar);
    ...
    private BarData createChartData(int[] yAll) {
        ...
        set1.setColor(ColorTemplate.PASTEL_COLORS[3]);
