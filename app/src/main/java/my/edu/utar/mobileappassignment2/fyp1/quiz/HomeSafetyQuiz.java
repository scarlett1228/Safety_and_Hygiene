...
import my.edu.utar.mobileappassignment2.fyp1.QuizStatistic.HomeStatisticActivity;
import my.edu.utar.mobileappassignment2.fyp1.R;


public class HomeSafetyQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_safety_quiz);

        String questions[] = {
                getResources().getString(R.string.home_quiz_question_1), //1st, 3rd
                getResources().getString(R.string.home_quiz_question_2), //1st,2nd,3rd
                getResources().getString(R.string.home_quiz_question_3), //1st, 3rd
                getResources().getString(R.string.home_quiz_question_4), //3rd
                getResources().getString(R.string.home_quiz_question_5), //3rd
                getResources().getString(R.string.home_quiz_question_6), //1st
                getResources().getString(R.string.home_quiz_question_7), //2nd, 4th
                getResources().getString(R.string.home_quiz_question_8), //2nd
                getResources().getString(R.string.home_quiz_question_9), //4th
                getResources().getString(R.string.home_quiz_question_10) //5th
        };

        String answers[] = { getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_false),
                getResources().getString(R.string.home_quiz_answer_false),getResources().getString(R.string.home_quiz_answer_true),
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_true),
                getResources().getString(R.string.home_quiz_answer_false),getResources().getString(R.string.home_quiz_answer_true),
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_true)};
        String option[] ={
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_false),
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_false),
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_false),
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_false),
                getResources().getString(R.string.home_quiz_answer_true),getResources().getString(R.string.home_quiz_answer_false),
        ...
        String hints[] = {
                getResources().getString(R.string.home_quiz_hints_1), //1
                getResources().getString(R.string.home_quiz_hints_2), // 2
                getResources().getString(R.string.home_quiz_hints_3), // 3
                getResources().getString(R.string.home_quiz_hints_4), //4
                getResources().getString(R.string.home_quiz_hints_5), //5
                getResources().getString(R.string.home_quiz_hints_6), //6
                getResources().getString(R.string.home_quiz_hints_7), // 7
                getResources().getString(R.string.home_quiz_hints_8), //8
                getResources().getString(R.string.home_quiz_hints_9), //9
                getResources().getString(R.string.home_quiz_hints_10) //10
        };
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if (mAuth.getCurrentUser() != null) {
                        //store DB
                        DatabaseReference dbref = FirebaseDatabase.getInstance().getReference("Users").child(mAuth.getCurrentUser().getUid()).child("HomeSafetyQuizResult");
                        //store all
                        ...
                        DatabaseReference dbrefpercentage = FirebaseDatabase.getInstance().getReference("Users").child(mAuth.getCurrentUser().getUid()).child("HomeSafetyhighestpercentage").child(currentDate);

                        final String timestamp = "" + System.currentTimeMillis();
                        HashMap<String, Object> hashMap = new HashMap<>();
                        hashMap.put("type", "Home Safety Quiz");
                    ...
                    restart.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            myDialog.dismiss();
                            Intent in = new Intent(HomeSafetyQuiz.this, HomeSafetyQuiz.class);
                    ...
                    ok.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            myDialog.dismiss();
                            Intent in = new Intent(HomeSafetyQuiz.this, QuizActivity.class);
                            in.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                            startActivity(in);
                            onBackPressed();
                        }
    ...
    public void comparehighestmark(int p, String currentDate){
        DatabaseReference dbrefpercentagecal = FirebaseDatabase.getInstance().getReference("Users").child(mAuth.getCurrentUser().getUid()).child("HomeSafetyhighestpercentage");
    ...
    public void hints(String h){
        hintsbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(HomeSafetyQuiz.this);
    ...
    public void onBackPressed() {
        correct = 0;
        wrong = 0;
        Intent i = new Intent(HomeSafetyQuiz.this,QuizActivity.class);
